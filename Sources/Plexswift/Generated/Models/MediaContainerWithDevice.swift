...
public struct MediaContainerWithDevice: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithDeviceMediaContainer?

    public init(
        mediaContainer: MediaContainerWithDeviceMediaContainer? = nil
    ) {
