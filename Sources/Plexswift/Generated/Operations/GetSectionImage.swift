...
extension Operations {
    ...
    public struct GetSectionImage: PlexOperation {
        public typealias Success = BinaryResponse

        public static let operationID = "getSectionImage"
        ...
        public var composite: GetSectionImageComposite?
        ...
        public var path: String { "/library/sections/\(PathComponent(sectionId))/composite/\(PathComponent(updatedAt))" }
