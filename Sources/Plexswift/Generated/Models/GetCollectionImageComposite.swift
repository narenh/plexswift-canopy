...
public struct GetCollectionImageComposite: Codable, Hashable, Sendable {
    /// Limit composite to specified metadata types
    public let type: Int?

    /// The image type
    public let format: GetCollectionImageCompositeFormat?
    ...
    public let crop: GetCollectionImageCompositeCrop?

    /// The height of the image
    public let height: Int?

    /// The default image type to use as the sources
    public let media: GetCollectionImageCompositeMedia?
    ...
    public init(
        type: Int? = nil,
        format: GetCollectionImageCompositeFormat? = nil,
        backgroundColor: String? = nil,
        border: Int? = nil,
        cols: Int? = nil,
        crop: GetCollectionImageCompositeCrop? = nil,
        height: Int? = nil,
        media: GetCollectionImageCompositeMedia? = nil,
        repeat: Bool? = nil,
        rows: Int? = nil,
        width: Int? = nil
    ) {
