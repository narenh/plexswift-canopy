...
public struct Metadata: Codable, Hashable, Sendable {
    ...
    public let guid2: [MetadataGuidItem]?
    ...
    public let skipChildren: MetadataSkipChildren?
    ...
    /// grandparent (show).
    public let skipParent: MetadataSkipParent?
    ...
    public init(
        ...
        search: Bool? = nil,
        secondary: Bool? = nil,
        skipChildren: MetadataSkipChildren? = nil,
        skipCount: Int? = nil,
        skipParent: MetadataSkipParent? = nil,
        slug: String? = nil,
        sort: [Sort]? = nil,
