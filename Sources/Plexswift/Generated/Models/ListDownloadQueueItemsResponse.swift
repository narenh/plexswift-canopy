...
public struct ListDownloadQueueItemsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: ListDownloadQueueItemsResponseMediaContainer?

    public init(
        mediaContainer: ListDownloadQueueItemsResponseMediaContainer? = nil
    ) {
