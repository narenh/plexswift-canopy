...
public struct GetPlaylistGeneratorItemsResponseMediaContainerMetadata: Codable, Hashable, Sendable {
    ...
    public let guid2: [GetPlaylistGeneratorItemsResponseMediaContainerMetadataGuidItem]?
    ...
    public let skipChildren: GetPlaylistGeneratorItemsResponseMediaContainerMetadataSkipChildren?
    ...
    /// grandparent (show).
    public let skipParent: GetPlaylistGeneratorItemsResponseMediaContainerMetadataSkipParent?
    ...
    public let processingState: GetPlaylistGeneratorItemsResponseMediaContainerMetadataProcessingState?

    /// The error which could have occurred (or `good`)
    public let processingStateContext: GetPlaylistGeneratorItemsResponseMediaContainerMetadataProcessingStateContext?
    ...
    public init(
        ...
        guid: String? = nil,
        guid2: [GetPlaylistGeneratorItemsResponseMediaContainerMetadataGuidItem]? = nil,
        hero: String? = nil,
        image: [Image]? = nil,
        index: Int? = nil,
        key: String? = nil,
        ...
        search: Bool? = nil,
        secondary: Bool? = nil,
        skipChildren: GetPlaylistGeneratorItemsResponseMediaContainerMetadataSkipChildren? = nil,
        skipCount: Int? = nil,
        skipParent: GetPlaylistGeneratorItemsResponseMediaContainerMetadataSkipParent? = nil,
        slug: String? = nil,
        sort: [Sort]? = nil,
        ...
        writer: [Tag]? = nil,
        year: Int? = nil,
        processingState: GetPlaylistGeneratorItemsResponseMediaContainerMetadataProcessingState? = nil,
        processingStateContext: GetPlaylistGeneratorItemsResponseMediaContainerMetadataProcessingStateContext? = nil
    ) {
        self.title = title
        self.type = type
        ...
        self.processingStateContext = processingStateContext
    }
