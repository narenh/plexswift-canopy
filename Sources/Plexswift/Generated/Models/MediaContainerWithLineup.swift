...
public struct MediaContainerWithLineup: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithLineupMediaContainer?

    public init(
        mediaContainer: MediaContainerWithLineupMediaContainer? = nil
    ) {
