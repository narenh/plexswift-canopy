...
public struct MediaContainerWithDecisionMediaContainerMetadataItem: Codable, Hashable, Sendable {
    ...
    public let guid2: [MediaContainerWithDecisionMediaContainerMetadataItemGuidItem]?
    ...
    public let media: [MediaContainerWithDecisionMediaContainerMetadataItemMediaItem]?
    ...
    public let skipChildren: MediaContainerWithDecisionMediaContainerMetadataItemSkipChildren?
    ...
    /// grandparent (show).
    public let skipParent: MediaContainerWithDecisionMediaContainerMetadataItemSkipParent?
    ...
    public init(
        ...
        guid: String? = nil,
        guid2: [MediaContainerWithDecisionMediaContainerMetadataItemGuidItem]? = nil,
        hero: String? = nil,
        image: [Image]? = nil,
        index: Int? = nil,
        key: String? = nil,
        ...
        leafCount: Int? = nil,
        media: [MediaContainerWithDecisionMediaContainerMetadataItemMediaItem]? = nil,
        ...
        search: Bool? = nil,
        secondary: Bool? = nil,
        skipChildren: MediaContainerWithDecisionMediaContainerMetadataItemSkipChildren? = nil,
        skipCount: Int? = nil,
        skipParent: MediaContainerWithDecisionMediaContainerMetadataItemSkipParent? = nil,
        slug: String? = nil,
        sort: [Sort]? = nil,
