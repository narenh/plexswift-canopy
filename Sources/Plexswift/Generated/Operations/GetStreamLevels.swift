...
extension Operations {
    ...
    public struct GetStreamLevels: PlexOperation {
        public typealias Success = GetStreamLevelsResponse

        public static let operationID = "getStreamLevels"
        ...
        public var path: String { "/library/streams/\(PathComponent(streamId))/levels" }
