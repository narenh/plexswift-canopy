...
public struct ComputeChannelMapResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let channelMapping: [ComputeChannelMapResponseMediaContainerChannelMappingItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        channelMapping: [ComputeChannelMapResponseMediaContainerChannelMappingItem]? = nil
    ) {
