...
public struct MediaContainerWithNestedMetadataMediaContainerMetadataItemItem: Codable, Hashable, Sendable {
    ...
    public let guid2: [MediaContainerWithNestedMetadataMediaContainerMetadataItemItemGuidItem]?
    ...
    public let skipChildren: MediaContainerWithNestedMetadataMediaContainerMetadataItemItemSkipChildren?
    ...
    /// grandparent (show).
    public let skipParent: MediaContainerWithNestedMetadataMediaContainerMetadataItemItemSkipParent?
    ...
    public init(
        ...
        guid: String? = nil,
        guid2: [MediaContainerWithNestedMetadataMediaContainerMetadataItemItemGuidItem]? = nil,
        hero: String? = nil,
        image: [Image]? = nil,
        index: Int? = nil,
        key: String? = nil,
        ...
        search: Bool? = nil,
        secondary: Bool? = nil,
        skipChildren: MediaContainerWithNestedMetadataMediaContainerMetadataItemItemSkipChildren? = nil,
        skipCount: Int? = nil,
        skipParent: MediaContainerWithNestedMetadataMediaContainerMetadataItemItemSkipParent? = nil,
        slug: String? = nil,
        sort: [Sort]? = nil,
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case writer = "Writer"
        case year
        case metadataItem = "MetadataItem"
    }
}
