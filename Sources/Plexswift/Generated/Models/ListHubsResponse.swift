...
public struct ListHubsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: ListHubsResponseMediaContainer?

    public init(
        mediaContainer: ListHubsResponseMediaContainer? = nil
    ) {
