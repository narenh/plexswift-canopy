...
public struct MediaContainerWithDecisionMediaContainerMetadataItemMediaItemPartItem: Codable, Hashable, Sendable {
    ...
    public let stream: [MediaContainerWithDecisionMediaContainerMetadataItemMediaItemPartItemStreamItem]?
    ...
    public let decision: MediaContainerWithDecisionMediaContainerMetadataItemMediaItemPartItemDecision?
    ...
    public init(
        ...
        decision: MediaContainerWithDecisionMediaContainerMetadataItemMediaItemPartItemDecision? = nil,
        selected: Bool? = nil
    ) {
