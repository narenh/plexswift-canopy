...
public struct ReportResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: ReportResponseMediaContainer?

    public init(
        mediaContainer: ReportResponseMediaContainer? = nil
    ) {
