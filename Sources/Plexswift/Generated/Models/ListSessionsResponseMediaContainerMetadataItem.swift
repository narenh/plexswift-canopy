...
public struct ListSessionsResponseMediaContainerMetadataItem: Codable, Hashable, Sendable {
    ...
    public let guid2: [ListSessionsResponseMediaContainerMetadataItemGuidItem]?
    ...
    public let skipChildren: ListSessionsResponseMediaContainerMetadataItemSkipChildren?
    ...
    /// grandparent (show).
    public let skipParent: ListSessionsResponseMediaContainerMetadataItemSkipParent?
    ...
    public init(
        ...
        guid: String? = nil,
        guid2: [ListSessionsResponseMediaContainerMetadataItemGuidItem]? = nil,
        hero: String? = nil,
        image: [Image]? = nil,
        index: Int? = nil,
        key: String? = nil,
        ...
        search: Bool? = nil,
        secondary: Bool? = nil,
        skipChildren: ListSessionsResponseMediaContainerMetadataItemSkipChildren? = nil,
        skipCount: Int? = nil,
        skipParent: ListSessionsResponseMediaContainerMetadataItemSkipParent? = nil,
        slug: String? = nil,
        sort: [Sort]? = nil,
