...
extension Operations {
    ...
    public struct GetPostplayHubs: PlexOperation {
        public typealias Success = MediaContainerWithHubs

        public static let operationID = "getPostplayHubs"
        ...
        public var path: String { "/hubs/metadata/\(PathComponent(metadataId))/postplay" }
