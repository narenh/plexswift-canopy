...
public struct MediaContainerWithStatus: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithStatusMediaContainer?

    public init(
        mediaContainer: MediaContainerWithStatusMediaContainer? = nil
    ) {
