...
extension Operations {
    ...
    public struct GetFirstCharacters: PlexOperation {
        public typealias Success = GetFirstCharactersResponse

        public static let operationID = "getFirstCharacters"
        ...
        public var path: String { "/library/sections/\(PathComponent(sectionId))/firstCharacters" }
