...
public struct ModifyDeviceResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: ModifyDeviceResponseMediaContainer?

    public init(
        mediaContainer: ModifyDeviceResponseMediaContainer? = nil
    ) {
