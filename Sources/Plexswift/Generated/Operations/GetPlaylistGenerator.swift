...
extension Operations {
    ...
    public struct GetPlaylistGenerator: PlexOperation {
        public typealias Success = GetPlaylistGeneratorResponse

        public static let operationID = "getPlaylistGenerator"
