...
public struct AddDownloadQueueItemsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: AddDownloadQueueItemsResponseMediaContainer?

    public init(
        mediaContainer: AddDownloadQueueItemsResponseMediaContainer? = nil
    ) {
