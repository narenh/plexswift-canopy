...
public struct UserPlexAccountSubscriptionsItem: Codable, Hashable, Sendable {
    ...
    public let status: UserPlexAccountSubscriptionsItemStatus?
    ...
    public init(
        ...
        plan: String? = nil,
        status: UserPlexAccountSubscriptionsItemStatus? = nil,
