...
public struct ListPlaybackHistoryResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: ListPlaybackHistoryResponseMediaContainer?

    public init(
        mediaContainer: ListPlaybackHistoryResponseMediaContainer? = nil
    ) {
