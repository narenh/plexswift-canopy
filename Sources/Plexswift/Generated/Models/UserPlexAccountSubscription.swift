...
public struct UserPlexAccountSubscription: Codable, Hashable, Sendable {
    /// If the account's Plex Pass subscription is active
    ...
    public let status: UserPlexAccountSubscriptionStatus?
    ...
    public init(
        ...
        plan: String? = nil,
        status: UserPlexAccountSubscriptionStatus? = nil,
