...
public struct GetTagsResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let directory: [GetTagsResponseMediaContainerDirectoryItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        directory: [GetTagsResponseMediaContainerDirectoryItem]? = nil
    ) {
