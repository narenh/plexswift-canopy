...
public struct Items: Codable, Hashable, Sendable {
    ...
    public let guid2: [ItemsGuidItem]?
    ...
    public let skipChildren: ItemsSkipChildren?
    ...
    /// grandparent (show).
    public let skipParent: ItemsSkipParent?
    ...
    public init(
        ...
        search: Bool? = nil,
        secondary: Bool? = nil,
        skipChildren: ItemsSkipChildren? = nil,
        skipCount: Int? = nil,
        skipParent: ItemsSkipParent? = nil,
        slug: String? = nil,
        sort: [Sort]? = nil,
