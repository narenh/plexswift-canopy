...
public struct GetPlaylistGeneratorsResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let playQueueGenerator: [GetPlaylistGeneratorsResponseMediaContainerPlayQueueGeneratorItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        playQueueGenerator: [GetPlaylistGeneratorsResponseMediaContainerPlayQueueGeneratorItem]? = nil
    ) {
        self.identifier = identifier
        self.offset = offset
        self.size = size
        self.totalSize = totalSize
        self.playQueueGenerator = playQueueGenerator
    }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case size
        case totalSize
        case playQueueGenerator = "PlayQueueGenerator"
    }
}
