...
public struct CreateDownloadQueueResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: CreateDownloadQueueResponseMediaContainer?

    public init(
        mediaContainer: CreateDownloadQueueResponseMediaContainer? = nil
    ) {
