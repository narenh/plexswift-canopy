...
public struct GetSourceConnectionInformationResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetSourceConnectionInformationResponseMediaContainer?

    public init(
        mediaContainer: GetSourceConnectionInformationResponseMediaContainer? = nil
    ) {
