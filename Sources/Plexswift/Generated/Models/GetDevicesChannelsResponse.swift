...
public struct GetDevicesChannelsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetDevicesChannelsResponseMediaContainer?

    public init(
        mediaContainer: GetDevicesChannelsResponseMediaContainer? = nil
    ) {
