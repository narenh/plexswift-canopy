...
public struct GetFirstCharactersResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let directory: [GetFirstCharactersResponseMediaContainerDirectoryItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        directory: [GetFirstCharactersResponseMediaContainerDirectoryItem]? = nil
    ) {
