...
public struct MediaContainerWithDirectory: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithDirectoryMediaContainer?

    public init(
        mediaContainer: MediaContainerWithDirectoryMediaContainer? = nil
    ) {
