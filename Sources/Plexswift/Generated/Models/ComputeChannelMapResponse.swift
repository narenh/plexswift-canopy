...
public struct ComputeChannelMapResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: ComputeChannelMapResponseMediaContainer?

    public init(
        mediaContainer: ComputeChannelMapResponseMediaContainer? = nil
    ) {
