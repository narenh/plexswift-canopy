...
public struct MediaContainerWithPlaylistMetadataMediaContainer: Codable, Hashable, Sendable {
    ...
    public let metadata: [MediaContainerWithPlaylistMetadataMediaContainerMetadataItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        metadata: [MediaContainerWithPlaylistMetadataMediaContainerMetadataItem]? = nil
    ) {
