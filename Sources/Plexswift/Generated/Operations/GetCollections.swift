...
extension Operations {
    ...
    public struct GetCollections: PlexOperation {
        public typealias Success = MediaContainerWithMetadata

        public static let operationID = "getCollections"
        ...
        public var path: String { "/library/sections/\(PathComponent(sectionId))/collections" }
