...
public struct RemoveDeviceFromDVRResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: RemoveDeviceFromDVRResponseMediaContainerMediaContainer?

    public let dvr: [DVR]?

    public init(
        mediaContainer: RemoveDeviceFromDVRResponseMediaContainerMediaContainer? = nil,
        dvr: [DVR]? = nil
    ) {
