...
public struct GetTemplateResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetTemplateResponseMediaContainer?

    public init(
        mediaContainer: GetTemplateResponseMediaContainer? = nil
    ) {
