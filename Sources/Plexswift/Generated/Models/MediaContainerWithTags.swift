...
public struct MediaContainerWithTags: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithTagsMediaContainer?

    public init(
        mediaContainer: MediaContainerWithTagsMediaContainer? = nil
    ) {
