...
public struct GetColorsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetColorsResponseMediaContainer?

    public init(
        mediaContainer: GetColorsResponseMediaContainer? = nil
    ) {
