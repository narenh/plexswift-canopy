...
public struct MediaContainerWithNestedMetadata: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithNestedMetadataMediaContainer?

    public init(
        mediaContainer: MediaContainerWithNestedMetadataMediaContainer? = nil
    ) {
