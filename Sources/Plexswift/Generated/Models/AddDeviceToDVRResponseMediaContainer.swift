...
public struct AddDeviceToDVRResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: AddDeviceToDVRResponseMediaContainerMediaContainer?

    public let dvr: [DVR]?

    public init(
        mediaContainer: AddDeviceToDVRResponseMediaContainerMediaContainer? = nil,
        dvr: [DVR]? = nil
    ) {
