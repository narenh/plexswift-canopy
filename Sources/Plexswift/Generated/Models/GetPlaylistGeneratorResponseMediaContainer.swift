...
public struct GetPlaylistGeneratorResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let item: [GetPlaylistGeneratorResponseMediaContainerItemItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        item: [GetPlaylistGeneratorResponseMediaContainerItemItem]? = nil
    ) {
