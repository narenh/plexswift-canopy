...
public struct AddDownloadQueueItemsResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let addedQueueItems: [AddedQueueItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        addedQueueItems: [AddedQueueItem]? = nil
    ) {
        self.identifier = identifier
        self.offset = offset
        self.size = size
        self.totalSize = totalSize
        self.addedQueueItems = addedQueueItems
    }
