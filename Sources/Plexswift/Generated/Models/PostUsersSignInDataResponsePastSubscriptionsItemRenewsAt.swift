...
public enum PostUsersSignInDataResponsePastSubscriptionsItemRenewsAt: Codable, Hashable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        throw DecodingError.typeMismatch(
            PostUsersSignInDataResponsePastSubscriptionsItemRenewsAt.self,
