...
public struct GetFoldersResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let directory: [GetFoldersResponseMediaContainerDirectoryItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        directory: [GetFoldersResponseMediaContainerDirectoryItem]? = nil
    ) {
