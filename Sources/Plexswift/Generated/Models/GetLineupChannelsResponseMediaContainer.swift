...
public struct GetLineupChannelsResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let lineup: [GetLineupChannelsResponseMediaContainerLineupItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        lineup: [GetLineupChannelsResponseMediaContainerLineupItem]? = nil
    ) {
