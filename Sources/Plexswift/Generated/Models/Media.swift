...
public struct Media: Codable, Hashable, Sendable {
    ...
    public let hasVoiceActivity: MediaHasVoiceActivity?

    public let height: Int?

    public let id: Int?

    public let optimizedForStreaming: MediaOptimizedForStreaming?
    ...
    public init(
        ...
        hasVoiceActivity: MediaHasVoiceActivity? = nil,
        height: Int? = nil,
        id: Int? = nil,
        optimizedForStreaming: MediaOptimizedForStreaming? = nil,
        part: [Part]? = nil,
        selected: Bool? = nil,
        uuid: String? = nil,
