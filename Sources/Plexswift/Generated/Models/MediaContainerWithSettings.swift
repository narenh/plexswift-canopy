...
public struct MediaContainerWithSettings: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithSettingsMediaContainer?

    public init(
        mediaContainer: MediaContainerWithSettingsMediaContainer? = nil
    ) {
