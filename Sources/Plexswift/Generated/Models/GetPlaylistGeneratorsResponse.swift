...
public struct GetPlaylistGeneratorsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetPlaylistGeneratorsResponseMediaContainer?

    public init(
        mediaContainer: GetPlaylistGeneratorsResponseMediaContainer? = nil
    ) {
