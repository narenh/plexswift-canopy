...
public struct MediaContainerWithNestedMetadataMediaContainer: Codable, Hashable, Sendable {
    ...
    public let metadataItem: [MediaContainerWithNestedMetadataMediaContainerMetadataItemItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        metadataItem: [MediaContainerWithNestedMetadataMediaContainerMetadataItemItem]? = nil
    ) {
