...
public struct MediaContainerWithSubscriptionMediaContainer: Codable, Hashable, Sendable {
    ...
    public let mediaSubscription: [MediaSubscription]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        mediaSubscription: [MediaSubscription]? = nil
    ) {
