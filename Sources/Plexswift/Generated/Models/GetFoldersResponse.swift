...
public struct GetFoldersResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetFoldersResponseMediaContainer?

    public init(
        mediaContainer: GetFoldersResponseMediaContainer? = nil
    ) {
