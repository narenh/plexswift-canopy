...
public struct CreateTransientTokenResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: CreateTransientTokenResponseMediaContainer?

    public init(
        mediaContainer: CreateTransientTokenResponseMediaContainer? = nil
    ) {
