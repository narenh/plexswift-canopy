...
public struct MediaContainerWithPlaylistMetadata: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithPlaylistMetadataMediaContainer?

    public init(
        mediaContainer: MediaContainerWithPlaylistMetadataMediaContainer? = nil
    ) {
