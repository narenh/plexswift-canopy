...
public struct CreateMarkerResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: CreateMarkerResponseMediaContainer?

    public init(
        mediaContainer: CreateMarkerResponseMediaContainer? = nil
    ) {
