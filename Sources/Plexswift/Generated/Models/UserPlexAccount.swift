...
public struct UserPlexAccount: Codable, Hashable, Sendable {
    ...
    public let adsConsentReminderAt: UserPlexAccountAdsConsentReminderAt?

    public let adsConsentSetAt: UserPlexAccountAdsConsentSetAt?
    ...
    public let mailingListStatus: UserPlexAccountMailingListStatus?
    ...
    public let services: [UserPlexAccountServicesItem]?

    /// If the account's Plex Pass subscription is active
    public let subscription: UserPlexAccountSubscription?

    /// Description of the Plex Pass subscription
    public let subscriptionDescription: String?

    public let subscriptions: [UserPlexAccountSubscriptionsItem]?
    ...
    public init(
        title: String? = nil,
        adsConsent: Bool? = nil,
        adsConsentReminderAt: UserPlexAccountAdsConsentReminderAt? = nil,
        adsConsentSetAt: UserPlexAccountAdsConsentSetAt? = nil,
        anonymous: Bool? = nil,
        ...
        mailingListStatus: UserPlexAccountMailingListStatus? = nil,
        maxHomeSize: Int? = nil,
        pin: String? = nil,
        ...
        services: [UserPlexAccountServicesItem]? = nil,
        subscription: UserPlexAccountSubscription? = nil,
        subscriptionDescription: String? = nil,
        subscriptions: [UserPlexAccountSubscriptionsItem]? = nil,
        thumb: String? = nil,
