...
public struct GetPlaylistGeneratorItemsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetPlaylistGeneratorItemsResponseMediaContainer?

    public init(
        mediaContainer: GetPlaylistGeneratorItemsResponseMediaContainer? = nil
    ) {
