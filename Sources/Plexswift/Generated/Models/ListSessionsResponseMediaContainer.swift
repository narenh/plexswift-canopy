...
public struct ListSessionsResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let metadata: [ListSessionsResponseMediaContainerMetadataItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        metadata: [ListSessionsResponseMediaContainerMetadataItem]? = nil
    ) {
