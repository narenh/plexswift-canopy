...
public struct GetBackgroundTasksResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let transcodeJob: [TranscodeJob]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        transcodeJob: [TranscodeJob]? = nil
    ) {
        self.identifier = identifier
        self.offset = offset
        self.size = size
        self.totalSize = totalSize
        self.transcodeJob = transcodeJob
    }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case size
        case totalSize
        case transcodeJob = "TranscodeJob"
    }
}
