...
public struct GetDownloadQueueResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetDownloadQueueResponseMediaContainer?

    public init(
        mediaContainer: GetDownloadQueueResponseMediaContainer? = nil
    ) {
