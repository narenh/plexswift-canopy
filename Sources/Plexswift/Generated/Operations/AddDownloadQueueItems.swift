...
extension Operations {
    ...
    public struct AddDownloadQueueItems: PlexOperation {
        public typealias Success = AddDownloadQueueItemsResponse

        public static let operationID = "addDownloadQueueItems"
        ...
        public var advancedSubtitles: AddDownloadQueueItemsAdvancedSubtitles?
        ...
        public var location: AddDownloadQueueItemsLocation?
        ...
        public var `protocol`: AddDownloadQueueItemsProtocol?
        ...
        public var subtitles: AddDownloadQueueItemsSubtitles?
        ...
        public var path: String { "/downloadQueue/\(PathComponent(queueId))/add" }
        ...
        public var queryItems: [URLQueryItem] {
            ...
            do {
                let value = keys
                items.append(URLQueryItem(name: "keys", value: value.map { QueryValue($0).encoded }.joined(separator: ",")))
            }
            return items
        }
    }
