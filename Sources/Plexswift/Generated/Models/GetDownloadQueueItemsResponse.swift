...
public struct GetDownloadQueueItemsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetDownloadQueueItemsResponseMediaContainer?

    public init(
        mediaContainer: GetDownloadQueueItemsResponseMediaContainer? = nil
    ) {
