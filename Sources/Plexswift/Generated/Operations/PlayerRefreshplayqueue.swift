...
extension Operations {
    ...
    public struct PlayerRefreshplayqueue: PlexOperation {
        public typealias Success = SuccessResponse

        public static let operationID = "playerRefreshplayqueue"
        ...
        public var path: String { "/player/playback/refreshPlayQueue" }
