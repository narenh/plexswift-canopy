...
public struct GetTemplateResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let subscriptionTemplate: [GetTemplateResponseMediaContainerSubscriptionTemplateItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        subscriptionTemplate: [GetTemplateResponseMediaContainerSubscriptionTemplateItem]? = nil
    ) {
        self.identifier = identifier
        self.offset = offset
        self.size = size
        self.totalSize = totalSize
        self.subscriptionTemplate = subscriptionTemplate
    }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case size
        case totalSize
        case subscriptionTemplate = "SubscriptionTemplate"
    }
}
