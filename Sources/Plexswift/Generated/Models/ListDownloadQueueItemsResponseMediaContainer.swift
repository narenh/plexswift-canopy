...
public struct ListDownloadQueueItemsResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let downloadQueueItem: [DownloadQueueItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        downloadQueueItem: [DownloadQueueItem]? = nil
    ) {
        self.identifier = identifier
        self.offset = offset
        self.size = size
        self.totalSize = totalSize
        self.downloadQueueItem = downloadQueueItem
    }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case size
        case totalSize
        case downloadQueueItem = "DownloadQueueItem"
    }
}
