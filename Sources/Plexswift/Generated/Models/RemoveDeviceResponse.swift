...
public struct RemoveDeviceResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: RemoveDeviceResponseMediaContainer?

    public init(
        mediaContainer: RemoveDeviceResponseMediaContainer? = nil
    ) {
