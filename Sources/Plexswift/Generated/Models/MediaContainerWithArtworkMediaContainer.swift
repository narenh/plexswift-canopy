...
public struct MediaContainerWithArtworkMediaContainer: Codable, Hashable, Sendable {
    ...
    public let metadata: [MediaContainerWithArtworkMediaContainerMetadataItem]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        metadata: [MediaContainerWithArtworkMediaContainerMetadataItem]? = nil
    ) {
