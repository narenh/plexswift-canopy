...
public struct GetLineupChannelsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetLineupChannelsResponseMediaContainer?

    public init(
        mediaContainer: GetLineupChannelsResponseMediaContainer? = nil
    ) {
