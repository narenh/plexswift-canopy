...
public struct DVRResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: DVRResponseMediaContainerMediaContainer?

    public let dvr: [DVR]?

    public init(
        mediaContainer: DVRResponseMediaContainerMediaContainer? = nil,
        dvr: [DVR]? = nil
    ) {
