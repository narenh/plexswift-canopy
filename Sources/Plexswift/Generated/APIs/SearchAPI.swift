...
/// The `Search` operations of the Plex API.
///
/// Reached through ``PlexClient/search``.
...
extension PlexClient {
    /// The `Search` operations of the Plex API.
    public var search: SearchAPI { SearchAPI(client: self) }
}
