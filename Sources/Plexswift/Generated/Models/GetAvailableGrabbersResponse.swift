...
public struct GetAvailableGrabbersResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetAvailableGrabbersResponseMediaContainer?

    public init(
        mediaContainer: GetAvailableGrabbersResponseMediaContainer? = nil
    ) {
