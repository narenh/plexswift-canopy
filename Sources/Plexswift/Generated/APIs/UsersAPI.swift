...
public struct UsersAPI: Sendable {
    ...
    @discardableResult
    public func createHomeUser() async throws(PlexError) -> SuccessResponse {
    ...
    @discardableResult
    public func getAccountJSON() async throws(PlexError) -> UserPlexAccount {
    ...
    @discardableResult
    public func getFriends() async throws(PlexError) -> GetFriendsResponse {
        try await client.perform(Operations.GetFriends())
    }

    /// Get Plex Home user list.
    @discardableResult
    public func getHome() async throws(PlexError) -> MediaContainerWithHubs {
        try await client.perform(Operations.GetHome())
    }

    /// Get the list of Plex Home users.
    @discardableResult
    public func getHomeUsers() async throws(PlexError) -> MediaContainerWithDirectory {
    ...
    @discardableResult
    public func getMyPlexAccount() async throws(PlexError) -> UserPlexAccount {
    ...
    public func getServerDetails(
        machineId: String
    ) async throws(PlexError) -> ServerConfiguration {
    ...
    @discardableResult
    public func getServerUserFeatures() async throws(PlexError) -> ServerUserFeaturesResponse {
    ...
    public func getUserOptOuts(
        uuid: String
    ) async throws(PlexError) -> UserOptOutsResponse {
    ...
    @discardableResult
    public func getUserServer() async throws(PlexError) -> ConnectionInfo {
    ...
    @discardableResult
    public func getUsers() async throws(PlexError) -> GetUsersResponse {
    ...
    @discardableResult
    public func shareServer() async throws(PlexError) -> SuccessResponse {
    ...
    @discardableResult
    public func updateViewStateSync() async throws(PlexError) -> SuccessResponse {
