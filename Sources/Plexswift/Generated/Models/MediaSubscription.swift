...
public struct MediaSubscription: Codable, Hashable, Sendable {
    public let title: String?

    /// The metadata type of the root item of the subscription
    public let type: Int?

    public let airingsType: MediaSubscriptionAiringsType?
    ...
    public init(
        title: String? = nil,
        type: Int? = nil,
        airingsType: MediaSubscriptionAiringsType? = nil,
        createdAt: Int? = nil,
