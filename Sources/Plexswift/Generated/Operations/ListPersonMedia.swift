...
extension Operations {
    ...
    public struct ListPersonMedia: PlexOperation {
        public typealias Success = MediaContainerWithMetadata

        public static let operationID = "listPersonMedia"
        ...
        public var path: String { "/library/people/\(PathComponent(personId))/media" }
    }
}
