...
public struct MediaContainerWithSubscription: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithSubscriptionMediaContainer?

    public init(
        mediaContainer: MediaContainerWithSubscriptionMediaContainer? = nil
    ) {
