...
public struct ListTopUsersResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: ListTopUsersResponseMediaContainer?

    public init(
        mediaContainer: ListTopUsersResponseMediaContainer? = nil
    ) {
