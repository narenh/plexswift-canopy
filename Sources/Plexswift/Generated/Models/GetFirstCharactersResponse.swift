...
public struct GetFirstCharactersResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetFirstCharactersResponseMediaContainer?

    public init(
        mediaContainer: GetFirstCharactersResponseMediaContainer? = nil
    ) {
