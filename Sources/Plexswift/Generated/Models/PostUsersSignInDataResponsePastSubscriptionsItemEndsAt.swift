...
public enum PostUsersSignInDataResponsePastSubscriptionsItemEndsAt: Codable, Hashable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        throw DecodingError.typeMismatch(
            PostUsersSignInDataResponsePastSubscriptionsItemEndsAt.self,
