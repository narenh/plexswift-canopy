...
public struct MediaContainerWithArtwork: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithArtworkMediaContainer?

    public init(
        mediaContainer: MediaContainerWithArtworkMediaContainer? = nil
    ) {
