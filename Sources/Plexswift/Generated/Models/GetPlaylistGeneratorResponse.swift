...
public struct GetPlaylistGeneratorResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetPlaylistGeneratorResponseMediaContainer?

    public init(
        mediaContainer: GetPlaylistGeneratorResponseMediaContainer? = nil
    ) {
