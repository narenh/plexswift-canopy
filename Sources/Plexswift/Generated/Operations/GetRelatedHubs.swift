...
extension Operations {
    ...
    public struct GetRelatedHubs: PlexOperation {
        public typealias Success = MediaContainerWithHubs

        public static let operationID = "getRelatedHubs"
        ...
        public var path: String { "/hubs/metadata/\(PathComponent(metadataId))/related" }
