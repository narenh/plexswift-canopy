...
public struct GetStreamLevelsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetStreamLevelsResponseMediaContainer?

    public init(
        mediaContainer: GetStreamLevelsResponseMediaContainer? = nil
    ) {
