...
public struct GetBackgroundTasksResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetBackgroundTasksResponseMediaContainer?

    public init(
        mediaContainer: GetBackgroundTasksResponseMediaContainer? = nil
    ) {
