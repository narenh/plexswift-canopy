...
public struct GetAllLanguagesResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetAllLanguagesResponseMediaContainer?

    public init(
        mediaContainer: GetAllLanguagesResponseMediaContainer? = nil
    ) {
