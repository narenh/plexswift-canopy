...
public struct GetSectionsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetSectionsResponseMediaContainer?

    public init(
        mediaContainer: GetSectionsResponseMediaContainer? = nil
    ) {
