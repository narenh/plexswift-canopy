...
extension Operations {
    ...
    public struct GenerateThumbs: PlexOperation {
        public typealias Success = Data

        public static let operationID = "generateThumbs"
        ...
        public var path: String { "/library/metadata/\(PathComponent(ids))/chapterThumbs" }
