...
public struct CreateSubscriptionResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: CreateSubscriptionResponseMediaContainer?

    public init(
        mediaContainer: CreateSubscriptionResponseMediaContainer? = nil
    ) {
