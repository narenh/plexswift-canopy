...
public struct MediaContainerWithSorts: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithSortsMediaContainer?

    public init(
        mediaContainer: MediaContainerWithSortsMediaContainer? = nil
    ) {
