...
public struct ListPlaybackHistoryResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let metadata: [PlaybackHistoryMetadata]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        metadata: [PlaybackHistoryMetadata]? = nil
    ) {
