...
public struct GetAvailableGrabbersResponseMediaContainer: Codable, Hashable, Sendable {
    ...
    public let mediaGrabber: [MediaGrabber]?
    ...
    public init(
        ...
        size: Int? = nil,
        totalSize: Int? = nil,
        mediaGrabber: [MediaGrabber]? = nil
    ) {
        self.identifier = identifier
        self.offset = offset
        self.size = size
        self.totalSize = totalSize
        self.mediaGrabber = mediaGrabber
    }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case size
        case totalSize
        case mediaGrabber = "MediaGrabber"
    }
}
