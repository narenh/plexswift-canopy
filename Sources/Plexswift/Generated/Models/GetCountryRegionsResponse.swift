...
public struct GetCountryRegionsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetCountryRegionsResponseMediaContainer?

    public init(
        mediaContainer: GetCountryRegionsResponseMediaContainer? = nil
    ) {
