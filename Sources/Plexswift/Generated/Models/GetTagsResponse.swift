...
public struct GetTagsResponse: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: GetTagsResponseMediaContainer?

    public init(
        mediaContainer: GetTagsResponseMediaContainer? = nil
    ) {
