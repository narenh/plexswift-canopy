...
public struct MediaContainerWithMediaGrabOperation: Codable, Hashable, Sendable {
    ...
    public let mediaContainer: MediaContainerWithMediaGrabOperationMediaContainer?

    public init(
        mediaContainer: MediaContainerWithMediaGrabOperationMediaContainer? = nil
    ) {
